...
if __name__ == '__main__':
    ...
    scd_args.num_iters = 3000
    scd_args.interval = 20
    scd_args.rounds = 1
    scd_args.w_inc1 = 0.05
    scd_args.updated_fc_features = 48
    scd_args.updated_conv_features = 1
    scd_args.n_jobs = 1
    scd_args.num_gpus = 1
    scd_args.adv_train = False
    scd_args.eps = 0.1
    scd_args.w_inc2 = 0.05
    ...
    scd_args.cuda = True
    scd_args.seed = 2018
    scd_args.target = 'toy_no_20_51_fp16'
